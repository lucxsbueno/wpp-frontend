...
const Input = props => {
  const { className, loading, type, placeholder, name, register, error, disabled, notErrorMessage } = props;
  ...
  return (
    <div className="w-100 mb-15">
      <input type={type} className={`input ${isError} ${isLoading} ${className}`.trim()}
